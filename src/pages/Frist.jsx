...
import potaoto from '../assets/potaoto.png'
...
function Frist() {
  return (
    ...
    <svg viewBox="0 0 36 36" style={{transform: 'rotate(-45deg)',overflow:'auto',position:'absolute',top:'20vw',right:'19vw', backgroundColor:'#1aa1c7',borderRadius:'50%'}}>
<path 
d="M18 2.0845
...
<div className='d-flex' style={{ flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position:'absolute',top:'30vw',left:'2vw'  }}>
      ...
      <div className='col order-1 order-lg-2' style={{ backgroundColor: '#7fdbf5', position: 'relative' ,zIndex:'-1'}}>
        <img src={pizza1} alt="" style={{ width: '15vw', position: 'absolute', top: '0', left: '0' }} />
        <img src={potaoto} alt="" style={{ width: '6vw', position: 'absolute', top: '-4vw', right: '.5vw' }} />
        <img src={bread} alt="" style={{ width: '10vw', position: 'absolute', bottom: '0', right: '0' }} />
        <img src={phone1} alt="" style={{ width: '20vw', position: 'absolute', bottom: '0', left: '4vw' }} />
