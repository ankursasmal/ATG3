...
<div className='d-flex' style={{ flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position:'absolute',top:'30vw',left:'2vw'  }}>
      ...
      <div className='col order-2 order-lg-1' style={{ backgroundColor: '#1b47cc'}}>
      ...
      <div className='col order-1 order-lg-2' style={{ backgroundColor: '#6786e0', position: 'relative' ,zIndex:'-1'}}>
