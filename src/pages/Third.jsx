...
<Link to='/sevens'> <div style={{width:'2vw',height:'2vw',borderRadius:'50%',backgroundColor:'blue',position:'absolute',top:'44vw',left:'5vw'}}></div></Link>
       ...
       <div className='col order-2 order-lg-1' style={{ backgroundColor: '#d2e61e'}}>
       ...
       <div className='col order-1 order-lg-2' style={{ backgroundColor: '#e4f07f', position: 'relative' ,zIndex:'-1'}}>
     
       <img src={divimg} alt="" style={{width:'20vw',position:'absolute',top:'-3vw',right:'2vw'}}/>
        <img src={social} alt="" style={{width:'25vw',position:'absolute',bottom:'0vw',left:'10vw'}}/>
  </div>
