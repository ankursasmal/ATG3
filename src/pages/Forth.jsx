...
import star from '../assets/star.png'
  ...
  function Forth() {
    ...
    <svg viewBox="0 0 36 36" style={{transform: 'rotate(-45deg)',overflow:'auto',position:'absolute',top:'20vw',right:'19vw',backgroundColor:'#cf6944',borderRadius:'50%' }}>
<path 
d="M18 2.0845
...
<Link to='/seven'> <div style={{width:'2vw',height:'2vw',borderRadius:'50%',backgroundColor:'blue',position:'absolute',top:'44vw',left:'5vw'}}></div></Link>
      ...
      <div className='d-flex' style={{ flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position:'absolute',top:'30vw',left:'2vw'  }}>
       ...
       <a style={{ alignSelf: 'flex-end',color:'white',fontSize:'1.2vw' }} >in furniture industry</a>
        ...
        <div className='col order-1 order-lg-2' style={{ backgroundColor: '#de957a', position: 'relative' ,zIndex:'-1'}}>
      
        <img src={police} alt="" style={{width:'20vw',position:'absolute',top:'30%',right:'3vw'}}/>
        <img src={movie} alt="" style={{width:'20vw',position:'absolute',top:'30%',left:'8vw'}}/>
 </div>
